...
void setup()
{
  ...
  SeeedOled.clearDisplay();
  SeeedOled.setTextXY(2, 4);
  SeeedOled.putString("Starting");  //
  SeeedOled.setTextXY(4, 4);
  SeeedOled.putString("Streaming..");  //
  delay(2000);
  ...
  {
    SeeedOled.setTextXY(4, 4);
    SeeedOled.putString("in IpV4");  //
    Serial.println("Error getting IP address via DHCP, trying again...");
    delay(15000);
  }
  SeeedOled.clearDisplay();
  SeeedOled.setTextXY(3, 0);
  SeeedOled.putString("Successful");
  delay(2000);
...
void loop() 
{
  ...
  if ((millis()-starttime) > sampletime_ms)//if the sampel time == 30s
  {
    ...
    Serial.print("Pollution Conc. is: ");
...
//void sendData(float concentration)
//{
