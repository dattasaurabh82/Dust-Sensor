//IxSR6tNxM8I1ASprVTIsvsk1WfyXtcdbQAoRwbRfvKOnofLB
//765780480
//sensorId[]
//
#include <SPI.h>
...
char xivelyKey[] = "IxSR6tNxM8I1ASprVTIsvsk1WfyXtcdbQAoRwbRfvKOnofLB";
...
XivelyFeed feed(765780480, datastreams, 1);
...
void loop() {
  ...
  if (ret > 0)
  {
   ...
   float var_Factor = feed[0].getFloat();
 }
  Serial.println();
  delay(15000);
}
